...
void BinaryTree::menu() {
    ...
    while (!exit) {
        ...
        case 1: // Display all data
            ...
            break;
        case 2: { // Start travel
            map(); // Show the map first
            bool travelExit = false;
            while (!travelExit) {
                cout << "\nTravel Menu:" << endl;
                cout << "1. Display All datas" << endl;
...
void BinaryTree::map(){
    ...
    cout << "    / /       / /                                                                                   /  /"<< endl;
    cout << "---/ /-------/ /------------| |------------| |------------------------| |---------| |--------------/  /"<< endl;
    cout << "                        (Bonneville)   (The'Dalles)               (John'Day)    (McNary)             /"<< endl;
    cout << "-------------------\\ \\---  -| |------------| |----------\\ \\------  ----| |--------| |---------------/"<< endl;
    cout << "                    \\ \\                                  \\ \\"<< endl;
    cout << "                     \\ \\                                  \\ \\"<< endl;
    cout << "                      \\ \\                               (Deschutes)"<< endl;
